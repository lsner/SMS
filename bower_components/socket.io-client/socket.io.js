...
var debug = _dereq_('debug')('socket.io-client:admin');
 ...
 * this method ensures the admin stops tracking us and
...
/**
 * A admin of a binary event's 'buffer sequence'. Should
